...
## 检查清单
- [ ] 能用一句话分别说清 MCP 和 Skills，并讲出两者区别
- [ ] 能说出 MCP 的三种原语（Tools / Resources / Prompts）
- [ ] 能解释 Skills 的渐进式披露为什么重要
- [ ] 能默画 Prompt ⊂ Context ⊂ Harness ⊂ Loop 的同心圆并解释每层作用域
- [ ] 能举例说明什么问题该用 Context Engineering 而不是继续堆 Prompt
